...
from core.filters.unscented_kalman_filter import UnscentedKalmanFilter
...
class EkfLocalization(Localization):
    def init_filter(self) -> Tuple[DataFilter, np.array]:
        ...
        data_filter = UnscentedKalmanFilter(initial_state.shape[0], self.robot_model.observations_dimension)
